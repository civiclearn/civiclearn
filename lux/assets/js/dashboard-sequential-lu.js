/* ────────────────────────────────────────────────────────
   Dashboard Sequential Practice — Luxembourg (v2)
   Same widget as Sweden; replaces the old fact-of-day widget.
...
(function () {
  ...
  async function initSequential() {
    ...
    const COUNTRY = (window.CIVICEDGE_CONFIG && window.CIVICEDGE_CONFIG.country) || "lu";
