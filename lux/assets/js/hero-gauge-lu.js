/* ──────────────────────────────────────────────────────
   CivicLearn — Dashboard hero gauge (Luxembourg)

   Draws the estimated-score ring inside the first stat
   card. Reads the same "cl_gauge_cache" that the sidebar
   gauge uses; dashboard-extra-lu.js writes it and fires
   "cl:gauge-updated" when it changes.

   The arc is filled with the Luxembourg flag colours
   (red → white → light blue), so a full ring = a full flag.
   ────────────────────────────────────────────────────── */
