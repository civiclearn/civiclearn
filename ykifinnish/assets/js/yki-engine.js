...
const YKIEngine = {
  ...
  async submitForEvaluation() {
    ...
    try {
      const response = await fetch(`${this.SUPABASE_URL}/functions/v1/yki-finnish-submit-test`, {
        method: 'POST',
        headers: {
  ...
  triggerAsyncEvaluations(attemptId) {
    ...
    fetch(`${this.SUPABASE_URL}/functions/v1/yki-finnish-evaluate-writing`, {
      method: 'POST',
      keepalive: true,
      headers: {
        'Content-Type': 'application/json',
    ...
    fetch(`${this.SUPABASE_URL}/functions/v1/yki-finnish-evaluate-speaking`, {
      method: 'POST',
      keepalive: true,
      headers: {
        'Content-Type': 'application/json',
