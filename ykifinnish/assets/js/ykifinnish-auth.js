/**
 * CivicAuth — Auth Guard (YKI Finnish)
 * ═══════════════════════════════════════════════════════════════
 ...
 *
 * Global: window.ykifinnishAuth
 * Event:  ykifinnishAuthReady
 */
...
(function () {
  ...
  const LOGIN_URL         = '/ykifinnish/login.html';
  ...
  auth.ready = (async () => {
    try {
      ...
      window.dispatchEvent(new CustomEvent('ykifinnishAuthReady', { detail: auth }));
