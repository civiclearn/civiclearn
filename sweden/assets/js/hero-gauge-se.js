/* ──────────────────────────────────────────────────────
   CivicLearn — Dashboard hero gauge (Sweden — medborgarskapsprovet)

   Draws the estimated-score ring inside the first stat
   card. Reads the same "cl_gauge_cache" that the sidebar
   gauge uses; dashboard-extra-se.js writes it and fires
   "cl:gauge-updated" when it changes.

   The arc is filled with the Swedish flag colours
   (blue → yellow → blue), so a full ring = a full flag.
   ────────────────────────────────────────────────────── */
    ...
    return (
      '<svg class="hero-ring" width="118" height="72" viewBox="0 0 130 78" aria-hidden="true">' +
        '<defs><linearGradient id="' + GRAD + '" x1="0" y1="0" x2="1" y2="0">' +
          ...
          '<stop offset="38%"  stop-color="#006AA7"/>' +
          '<stop offset="50%"  stop-color="#FECC02"/>' +
          '<stop offset="62%"  stop-color="#006AA7"/>' +
