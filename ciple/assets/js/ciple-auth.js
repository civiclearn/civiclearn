/**
 * CivicAuth — Auth Guard (CIPLE)
 *
 * Usage in HTML:
 *   <script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/dist/umd/supabase.min.js"></script>
 *   <script src="/ciple/assets/js/ciple-auth.js"></script>
 *
 * Global: cipleAuth { email, userId, session, supabase, signOut(), ready }
 */
...
(function () {
  ...
  const LOGIN_URL         = '/ciple/login.html';
  ...
  auth.ready = (async () => {
    try {
      ...
      window.dispatchEvent(new CustomEvent('cipleAuthReady', { detail: auth }));
