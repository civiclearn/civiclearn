/* ──────────────────────────────────────────────────────
   CivicLearn — Dashboard hero gauge (Finland — kansalaisuuskoe)

   Draws the estimated-score ring inside the first stat
   card. Reads the same "cl_gauge_cache" that the sidebar
   gauge uses; dashboard-extra-fi.js writes it and fires
   "cl:gauge-updated" when it changes.

   The arc is filled with the Finnish flag colours
   (blue → white → blue), so a full ring = a full flag.
   ────────────────────────────────────────────────────── */
    ...
    return (
      '<svg class="hero-ring" width="118" height="72" viewBox="0 0 130 78" aria-hidden="true">' +
        '<defs><linearGradient id="' + GRAD + '" x1="0" y1="0" x2="1" y2="0">' +
          ...
          '<stop offset="38%"  stop-color="#003580"/>' +
          '<stop offset="50%"  stop-color="#FFFFFF"/>' +
          '<stop offset="62%"  stop-color="#003580"/>' +
