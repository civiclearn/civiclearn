/* ─────────────────────────────────────────────────────────
   CivicLearn Dashboard Extra — Finland
...
(function () {
  ...
  function computeAndCacheGauge() {
    ...
    let badgeText;
    if (passed) {
      badgeText = lang === "fi" ? "Hyväksytty" : lang === "sv" ? "Godkänd" : "Would pass";
    } else if (close) {
      badgeText = lang === "fi" ? "Melkein" : lang === "sv" ? "Nästan" : "Almost there";
    } else {
      badgeText = lang === "fi" ? "Harjoittele lisää" : lang === "sv" ? "Behöver öva mer" : "Needs practice";
    }
