...
window.CIVICEDGE_CONFIG = {
  ...
  /* -------------------------------
     ...
     ------------------------------- */
  bank: {
    path: "/indfodsret/banks/questions.json",
    format: "flat"
  },
  ...
  flashcards: {
    mode: "topics-only",
    placeholder: "/indfodsret/assets/images/icons/flag-watermark-dk.svg"
  },
  ...
  simulation: {
    ...
    /* Estimated topic quotas for readiness gauge.
       35 manual distributed across 6 topics + 5 values + 5 current = 45 */
    topicQuotas: {
      "Demokrati": 8,
      "Historie": 7,
      "Kulturliv": 6,
