/* ────────────────────────────────────────────────────────
   Dashboard Sequential Practice — Cyprus (v2)
...
(function () {
  ...
  async function initSequential() {
    ...
    const COUNTRY = (window.CIVICEDGE_CONFIG && window.CIVICEDGE_CONFIG.country) || "cy";
    ...
    function render() {
      ...
      const text = (typeof q.q === "object") ? (q.q[lang] || q.q.el || q.q.en || "") : (q.q || "");
      ...
      const rawOpts = (typeof q.options === "object" && !Array.isArray(q.options))
        ? (q.options[lang] || q.options.el || q.options.en || [])
        : (q.options || []);
    ...
    function recordToProgress(q, correct) {
      try {
        ...
        // Same key format as engine: microtopic.en:questionId
    ...
    function recordToStats(q, correct, userAnswerText, correctAnswerText) {
      try {
        ...
        session.questions.push({
          ...
          qText: (typeof q.q === "object") ? (q.q[lang] || q.q.el || q.q.en || "") : (q.q || ""),
